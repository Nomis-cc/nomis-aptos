// ------------------------------------------------------------------------------------------------------
// <copyright file="AptosScoreCalculator.cs" company="Nomis">
...
{
    /// <summary>
    /// Aptos wallet score calculator.
    /// </summary>
    internal static class AptosScoreCalculator
    {
        ...
        public static double GetScore(this IWalletStats<AptosTransactionIntervalData> stats)
        {
            if (stats.NoData)
            {
                return 0;
